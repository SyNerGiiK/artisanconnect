        ...
        <div className="overflow-hidden rounded-2xl bg-white shadow-xl ring-1 ring-gray-100">
          ...
          <div className="relative px-8 pb-10">
            ...
            <div className="-mt-16 mb-6 flex items-end gap-6">
              <div className="flex h-32 w-32 items-center justify-center rounded-2xl bg-white text-3xl font-bold text-indigo-600 shadow-lg ring-4 ring-white">
            ...
            <div className="mb-8 flex flex-wrap gap-2">
              {metiers.map((m) => (
                <span
                  key={m.slug}
                  className="inline-flex items-center rounded-full bg-indigo-50 px-4 py-1.5 text-sm font-medium text-indigo-700 ring-1 ring-indigo-200"
                >
                  {m.libelle}
                </span>
              ))}
            ...
            <div className="rounded-xl bg-gradient-to-r from-indigo-500 to-purple-600 p-8 text-center text-white">
              ...
              <Link
                href="/inscription"
                className="inline-flex items-center gap-2 rounded-xl bg-white px-8 py-3.5 text-base font-semibold text-indigo-600 shadow-lg transition-all hover:shadow-xl hover:scale-105"
              >
